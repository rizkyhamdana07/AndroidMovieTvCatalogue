package com.rizkyhamdana.movietvcatalogue.core.data

import com.rizkyhamdana.movietvcatalogue.core.data.source.local.LocalDataSource
import com.rizkyhamdana.movietvcatalogue.core.data.source.remote.RemoteDataSource
import com.rizkyhamdana.movietvcatalogue.core.data.source.remote.api.ApiResponse
import com.rizkyhamdana.movietvcatalogue.core.data.source.remote.response.DetailsMovieResponse
import com.rizkyhamdana.movietvcatalogue.core.data.source.remote.response.DetailsTvResponse
import com.rizkyhamdana.movietvcatalogue.core.data.source.remote.response.ResultsMovie
import com.rizkyhamdana.movietvcatalogue.core.data.source.remote.response.ResultsTv
...
import com.rizkyhamdana.movietvcatalogue.core.domain.repository.ICatalogueRepository
import com.rizkyhamdana.movietvcatalogue.core.utils.AppExecutors
import com.rizkyhamdana.movietvcatalogue.core.utils.DataMapper
...
class CatalogueRepository(
    ...
    override fun getMoviePopular(): Flow<Resource<List<Movies>>> =
        object : com.rizkyhamdana.movietvcatalogue.core.data.NetworkBoundResource<List<Movies>, List<ResultsMovie>>(){
            ...
            override suspend fun createCall(): Flow<ApiResponse<List<ResultsMovie>>> = remoteDataSource.getPopularMovie()
    ...
    override fun getTvPopular(): Flow<Resource<List<TvShow>>> =
        object : com.rizkyhamdana.movietvcatalogue.core.data.NetworkBoundResource<List<TvShow>, List<ResultsTv>>(){
            ...
            override suspend fun createCall(): Flow<ApiResponse<List<ResultsTv>>> = remoteDataSource.getPopularTv()
    ...
    override fun getDetailsMovie(id: Int): Flow<Resource<Movies>> =
        object : com.rizkyhamdana.movietvcatalogue.core.data.NetworkBoundResource<Movies, DetailsMovieResponse>(){
            ...
            override suspend fun createCall(): Flow<ApiResponse<DetailsMovieResponse>> = remoteDataSource.getDetailsMovie(id)
    ...
    override fun getDetailsTv(id: Int): Flow<Resource<TvShow>> =
        object : com.rizkyhamdana.movietvcatalogue.core.data.NetworkBoundResource<TvShow, DetailsTvResponse>() {
            ...
            override suspend fun createCall(): Flow<ApiResponse<DetailsTvResponse>> = remoteDataSource.getDetailsTv(id)
